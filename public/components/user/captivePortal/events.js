...
export default async function Events() {
    ...
    if (courseSelect) {
        ...
        validateForm(nameInput, consentCheckbox, studentIdInput, submitBtn);
        
        // Add event listeners for validation
        nameInput.addEventListener('input', () => validateForm(nameInput, consentCheckbox,studentIdInput, submitBtn));
        studentIdInput.addEventListener('input', () => validateForm(nameInput, consentCheckbox,studentIdInput, submitBtn));
        consentCheckbox.addEventListener('change', () => validateForm(nameInput, consentCheckbox, studentIdInput, submitBtn));
